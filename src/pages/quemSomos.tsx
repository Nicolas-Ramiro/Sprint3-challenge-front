      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 justify-items-center">
        ...
        <div className="flex flex-col items-center text-center max-w-[350px]">
          ...
          <p className="text-justify md:text-lg leading-relaxed">
            Hebert traz para a MindDev sua vasta experiência em vendas,
            combinando conhecimento técnico com habilidades comerciais para
            ampliar o alcance das soluções desenvolvidas. Seu talento para
            entender o mercado e criar conexões estratégicas é fundamental para
            transformar ideias em oportunidades reais.
          </p>
          <p className="text-md">
            RM: 563192<br />1TDSR
          </p>
          <a
            href="https://github.com/hebertlps"
        ...
        <div className="flex flex-col items-center text-center max-w-[350px]">
          ...
          <p className="text-justify md:text-lg leading-relaxed">
            Marcus é um líder e gerente de projetos dedicado, que conduz a
            MindDev com visão clara e foco na entrega de resultados. Sua
            capacidade de organizar equipes, alinhar objetivos e motivar pessoas
            garante que cada projeto seja executado com excelência e eficiência.
          </p>
          <p className="text-md">
            RM: 558771<br />1TDSR
          </p>
          <a
            href="https://github.com/marcusvilanova"
            className="!text-white hover:underline"
          >
            GitHub
          </a>
        ...
        <div className="flex flex-col items-center text-center max-w-[350px]">
          ...
          <p className="text-justify md:text-lg leading-relaxed">
            Nicolas é o especialista em códigos da MindDev, reconhecido por sua
            habilidade excepcional em desenvolvimento de software. Ele
            transforma desafios complexos em soluções digitais robustas e
            inovadoras, elevando a qualidade técnica dos projetos e garantindo a
            funcionalidade que o usuário espera.
          </p>
          <p className="text-md">
            RM: 562380<br />1TDSR
          </p>
          <a
            href="https://github.com/Nicolas-Ramiro/"
            className="!text-white hover:underline"
          >
            GitHub
          </a>
