...
const Home: React.FC = () => {
    return (
        <main className="flex flex-col md:flex-row items-center justify-between bg-gradient-to-b from-zinc-950 via-zinc-800 to-zinc-900 text-white min-h-[80vh] px-10 lg:px-20 py-16">
            {/* Texto lado esquerdo */}
